...
export class PaiementService extends BaseService {
  ...
  async effectuerPaiement(pack: Pack, user: User, isYearly: boolean = false, cardElement: StripeCardElement): Promise<any> {
    ...
    try {
      ...
      // If payment is successful, save the payment in our database
